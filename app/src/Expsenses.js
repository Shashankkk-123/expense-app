...
class Expsenses extends Component {
    ...
    async handleSubmit(event){
      ...
      try {
        ...
        // Fetch the updated list of expenses after saving
        const responseExp = await fetch('/api/expenses');
        const updatedExpenses = await responseExp.json();
        ...
        return (
            <div>
                ...
                <Container>
                    ...
                    <FormGroup>
                        <Label for="category" style={{ marginRight: '5px' }}>Category:</Label>
                    ...
                    <FormGroup>
                        <Label for="city"style={{ marginRight: '5px' }}>Date:</Label>
